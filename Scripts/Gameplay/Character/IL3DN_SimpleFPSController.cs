...
namespace IL3DN
{
    ...
    public class IL3DN_SimpleFPSController : MonoBehaviour
    {
        ...
        public bool enableInputPrior = true;
        [HideInInspector] public Camera m_Camera;
        private bool m_Jump;
        private float m_YRotation;
        private Vector2 m_Input;
        public Vector2 inputDir => (enableInput && enableInputPrior) ? m_Input : Vector2.zero;
        private Vector3 m_MoveDir = Vector3.zero;
        private CharacterController m_CharacterController;
        public float currentSpeed => m_CharacterController.velocity.magnitude;
        ...
        private void Start()
        {
            ...
            m_FPSBobing = GetComponent<FPSBobing>();
        }

        private void Update()
        {
            if (!enableInput || !enableInputPrior) return;
            m_FPSBobing.PositionBobing();
            RotateView();

            m_FPSBobing.RotationBobing();
        ...
        {
            m_MouseLook.LookRotation(transform, m_Camera.transform, m_FPSBobing);
        ...
        {
            var soundScript = other.GetComponent<IL3DN_ChangeWalkingSound>();
            if (soundScript == null) return;
